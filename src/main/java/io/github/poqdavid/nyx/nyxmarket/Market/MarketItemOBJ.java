...
public class MarketItemOBJ implements Serializable {
    ...
    public MarketItemOBJ withPlayer(UUID player) {
        this.player = player;
        return this;
    }
    ...
    public MarketItemOBJ withWorld(UUID world) {
        this.world = world;
        return this;
    }
    ...
    public MarketItemOBJ withItemData(String itemData) {
        this.itemData = itemData;
        return this;
    }
    ...
    public MarketItemOBJ withCreationTime(Date creationTime) {
        this.creationTime = creationTime;
        return this;
    }
    ...
    public MarketItemOBJ withPrice(BigDecimal price) {
        this.price = price;
        return this;
    }
    ...
    public MarketItemOBJ withAmount(Integer amount) {
        this.amount = amount;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MarketItemOBJ) == false) {
            return false;
        }
        MarketItemOBJ rhs = ((MarketItemOBJ) other);
